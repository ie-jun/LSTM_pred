...
def main(args):
    ...
    #getitem으로 얻는 shape는 X['input']은 (enb개수,lag값,col개수)
    # getitem으로 얻는 shape는 X['label']은 (enb개수,pred_steps,col개수)
    ...
    #각 loader의 한 iter는 X['input']은 (batch_size,enb개수,lag값,col개수)
    # 각 loader의 한 iter는 X['label']은 (batch_size,enb개수,pred_steps,col개수)
